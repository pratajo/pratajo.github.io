...
thumbnail: assets/img/fedora44xfce.jpg
featured: true
toc:
  sidebar: right
---
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/fedora44xfce.jpg" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
...
```bash
sudo dnf install thunderbird 7zip unrar gsmartcontrol libreoffice-draw libreoffice-impress libreoffice-langpack-pt-PT vlc geeqie hplip-gui simple-scan
```
