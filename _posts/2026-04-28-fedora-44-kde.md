...
last_modified_at: 2026-05-01 17:00:00
description: Fedora 44 KDE Plasma
tags: fedora kde
categories: operating-systems
thumbnail: assets/img/fedora44kde_dark.jpg
featured: true
toc:
  sidebar: right
images:
...
<img-comparison-slider>
  {% include figure.liquid path="assets/img/fedora44kde_light.jpg" class="img-fluid rounded z-depth-1" slot="first" %}
  {% include figure.liquid path="assets/img/fedora44kde_dark.jpg" class="img-fluid rounded z-depth-1" slot="second" %}
</img-comparison-slider>

&nbsp;

###### **Get Fedora 44 KDE Plasma**
...
```bash
sudo dnf install thunderbird ktorrent gimp gimp-help gimp-help-pt_BR 7zip unrar gsmartcontrol libreoffice-langpack-pt-PT haruna amarok inkscape scribus kde-l10n-pt kate kdenlive krita qcad xsane hplip-gui
